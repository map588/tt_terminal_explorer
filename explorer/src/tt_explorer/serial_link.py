...
While raw mode is active (interactive firmware sessions such as a
program loader or debugger), incoming chunks bypass the line router
and go to the raw sink.
"""
...
class SerialLink:
    ...
    # -- raw mode (interactive session passthrough) --
